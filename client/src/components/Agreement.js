  ...
  render() {
    return (
      <div style={{ display: 'inline-block' }}>
        <a type="primary" onClick={this.showModal}>网站用户注册协议</a>
        <Modal
          title="网站用户注册协议" visible={this.state.visible}
          onOk={this.handleOk} onCancel={this.handleCancel}
          width={800}
          okText={'接受'}
          cancelText={'取消'}
        >
          <p>尊敬的用户您好，欢迎您访问万汇典藏网站（以下简称：网站）。在您注册成为网站会员之前，请您务必认真阅读和理解《网站用户注册协议》（以下简称：协议）中所有的条款。您须完全同意协议中所有的条款，才可以注册成为本网站的会员，使用里面的服务。您在网站的注册和操作均将被视为是您对协议所有条款及内容的自愿接受。</p>
          <h3>第一条 声明</h3>
          <p>（一）网站内在线产品的所有权归万汇典藏网站所有。</p>
          ...
          <p> 3、如果本网站发现您传输的信息含有本协议第二条所列内容之一的，本网站有权在不通知您的情况下采取包括但不仅限于向国家有关机关报告、保存有关记录、删除该内容及链接地址、关闭服务器、暂停您账号的操作权限、停止向您提供服务等措施；</p>
          <p> 第三条 注册会员权利和义务</p>
          ...
          <h3>第四条 用户隐私</h3>
          <p> 我们承诺，对您个人的信息和隐私的安全承担保密义务。未经您授权或同意，本网站不会将您的个人资料信息泄露给第三方，但以下情况除外，且本网站不承担任何责任：</p>
          ...
          <p> （四）您通过本网站链接其他网站造成的个人资料泄露以及由此导致的任何法律争议和后果；</p>
          <p> （五）为免除他人正在遭受威胁到其生命、身体或财产等方面的危险，所采取的措施；</p>
          <p> （六）本网站会与其他网站链接，但不对其他网站的隐私政策及内容负责；</p>
          <p> （七）此外，您若发现有任何非法使用您的用户账号或安全漏洞的情况，应立即通告本网站；</p>
          <p> （八）由于您自身的疏忽、大意等过错所导致的；</p>
          <p> （九）您在本网站的有关记录有可能成为您违反法律法规和本协议的证据；</p>
          <h3>第五条 知识产权</h3>
          <p> 本网站所有的域名、商号、商标、文字、视像及声音内容、图形及图像均受有关所有权和知识产权法律的保护，未经本网站事先以书面明确允许，任何个人或单位，均不得进行复制和使用。</p>
          <h3>第六条 法律适用</h3>
